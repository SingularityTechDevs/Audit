"""
Django settings for tdactvs project.
...
SECRET_KEY = 'django-insecure-px=rq6u6nf*_c)xactviu!#oy9axs7=1w&)l3^!80ye9o!e-h6'
...
WSGI_APPLICATION = 'tdactvs.wsgi.application'
